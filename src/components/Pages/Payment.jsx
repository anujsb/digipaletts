const Payment = () => {
  return (
    <div>
      ...
      <div className="text-black h-screen m-10 grid md:grid-cols-2 lg:grid-cols-2 sm:grid-cols-1">
        <div className="card rounded-lg border-black  bg-yellow-300 m-5 shadow-lg text-center">
          <h2 className="text-4xl mx-2 my-5">For digital marketing services</h2>
