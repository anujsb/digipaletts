      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        ...
        <div className="grid max-w-3xl grid-cols-1 mx-auto mt-8 text-center sm:mt-16 sm:text-left sm:grid-cols-2 gap-y-8 gap-x-8 lg:gap-x-20">
          <div className="relative group">
            ...
            <p className="mt-6 text-sm font-normal text-gray-600 font-pj">November 22, 2023</p>
            <p className="mt-4 text-xl font-bold text-gray-900 font-pj">Blog 1</p>
            <a href="#" title="">
          ...
          <div className="relative group">
            ...
            <p className="mt-6 text-sm font-normal text-gray-600 font-pj">November 16, 2023</p>
